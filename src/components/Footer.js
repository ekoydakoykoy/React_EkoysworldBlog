...
function Footer() {
    ...
    return (
        <div className={`footer-container ${theme ? 'theme-dark' : 'theme-light'}`}>
            <section className={`footer-subscription ${theme ? 'theme-dark' : 'theme-light'}`}>
                ...
                <div className="input-areas">
                    <form action="">
                        ...
                        >
                    <Button buttonClass={theme ? 'theme-dark' : 'theme-light'} buttonStyle='btn--outline'>Subscribe</Button>
                    </form>
                </div>
            </section>
            <div className="footer-links">
                <div className="footer-link-wrapper">
                    <div className={`footer-link-items ${theme ? 'theme-dark' : 'theme-light'}`}>
                        <h2> About us</h2>
            ...
            <section className="social-media">
                <div className="social-media-wrap">
                    <div className="footer-logo">
                        <Link to='/' className={`social-logo ${theme ? 'theme-dark' : 'theme-light'}`}>
                            <i className="fas fa-globe-asia" /> &nbsp; Ekoy's World 
                        </Link>
                    </div>
                    <small className={`website-rights ${theme ? 'theme-dark' : 'theme-light'}`}> &nbsp; &nbsp; &nbsp;Ekoy's World © 2021</small>
                    <div className="social-icons">
                        <Link className={`social-icon-link facebook ${theme ? 'theme-dark' : 'theme-light'}`} 
                        ...
                        <Link className={`social-icon-link instagram ${theme ? 'theme-dark' : 'theme-light'}`}
                        ...
                        <Link className={`social-icon-link youtube ${theme ? 'theme-dark' : 'theme-light'}`}
