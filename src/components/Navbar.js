    ...
    <>
      <nav className={`navbar ${theme ? "theme-dark" : "theme-light"}`}>
        <div className="navbar-container">
          <Link
            to="/"
            className={`navbar-logo ${theme ? "theme-dark" : "theme-light"}`}
          ...
          <div
            className={`navbar-theme ${theme ? "theme-dark" : "theme-light"}`}
          ...
          >
            <li className="nav-item">
              <Link
                to="/"
                className={`nav-links ${theme ? "theme-dark" : "theme-light"}`}
                onClick={closeMobileMenu}
              >
                Home
              </Link>
          ...
          {button && (
            <Link
              to="/add-post"
              className={`btn-mobile ${theme ? "theme-dark" : "theme-light"}`}
            >
              {" "}
              <Button
